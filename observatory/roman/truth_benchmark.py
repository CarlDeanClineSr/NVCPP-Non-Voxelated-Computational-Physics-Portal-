...
The benchmark is deliberately simple and dependency-light.  It provides a stable
regression surface that can later be applied to Roman I-Sim exports after those
products pass their own source and schema contracts.
"""
...
from .synthetic_fixture import DQ_COSMIC_RAY, load_fixture
